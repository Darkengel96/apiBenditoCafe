...
router.post('/api/INSVENTAS', (req, res) => {
    ...
    try {
        ...
        const { VNOMBRE, VCOD_VENTA, VTAMANIO, VPRECIO, VNOMBRE_CLIENTE, VUSER, VCANTIDAD, VTOTAL, VRECIBIDO, VCAMBIO } = req.body;
        const consulta = `call SP_INGRESO_VENTA2 ('${VNOMBRE}','${VCOD_VENTA}','${VTAMANIO}','${VPRECIO}','${VNOMBRE_CLIENTE}','${VUSER}','${VCANTIDAD}','${VTOTAL}','${VRECIBIDO}','${VCAMBIO}')`;
